...
\include{chapters/composicao/1-frontPage}
\include{chapters/composicao/2-secondPage}

%Numeração Romana para os capítulos de estrutura
\pagenumbering{roman}
\setcounter{page}{1}

\include{chapters/composicao/3-dedicatoria}
\include{chapters/composicao/4-agradecimentos}
\oddPageStart
\include{chapters/composicao/5-resumo}
...
\include{chapters/composicao/7-abbreviations}
\printglossary
...
\oddPageStart
\include{chapters/conteudo/1-Introducao}
\oddPageStart
\include{chapters/conteudo/2-EstadoArte}
\oddPageStart
\include{chapters/conteudo/3-Analise}
\oddPageStart
\include{chapters/conteudo/4-Implementacao}
\oddPageStart
\include{chapters/conteudo/5-Conclusoes}
