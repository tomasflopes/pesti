...
analisar o uso de recursos de um dos \textit{\glspl{cluster}}. A restante análise encontra-se
presente em anexo.

\todo{Adicionar o anexo}
...
das topologias pelos \textit{\glspl{cluster}} de forma a otimizar o uso de recursos dos mesmos.
...
alternativas que serão analisadas subsequentemente. A ideia é criar um novo \textit{\gls{cluster}}
para receber as topologias que não necessitam de tanto poder computacional associado. Desta forma,
será possível libertar os restantes \textit{\glspl{cluster}} do número excessivo de \acp{VM} e, ao
reduzir os \textit{\glspl{flavour}} de todas as \acp{VM} procedemos à redução do uso total do
conjunto.
...
\todo[inline]{Falar prós e contras desta alternativa}
...
\todo[inline]{Falar sobre as 3 opções e o porquê da 1 (com 8 RAM) ter sido a escolhida}
...
\begin{figure}[H]
  \centerline{\includegraphics[scale=0.4]{media/content/analise/strat-current.png}}
  \caption{Processo de implantação - Estado atual}
  \label{strat-current}
\end{figure}

\begin{figure}[H]
  \centerline{\includegraphics[scale=0.4]{media/content/analise/strat-1.png}}
  \caption{Processo de implantação - Passo 1}
  \label{strat-1}
\end{figure}

\begin{figure}[H]
  \centerline{\includegraphics[scale=0.4]{media/content/analise/strat-2.png}}
...
\begin{figure}[H]
  \centerline{\includegraphics[scale=0.4]{media/content/analise/strat-3.png}}
