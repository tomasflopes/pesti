...
todos os serviços disponibilizados pelo \textit{gls{cluster}} são relativos ao catálogo, ou seja,
à informação relativa aos vários eventos disponibilizados aos clientes.
