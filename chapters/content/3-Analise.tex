...
\todo[inline]{Contextualizar o problema, possivelmente alguns tópicos da introdução transitam
para esta secção}

\todo[inline]{Introduzir OFS, OFSEC - clusters de serviços}

\todo[inline]{Introduzir abordagem de 3 clusters}
