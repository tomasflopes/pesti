...
\begin{figure}[H]
    \centering
    \subfloat[\centering Vista lógica]{{\includegraphics[width=0.3\textwidth]{media/content/estado-arte/client-server-logical.png} }}%
    \qquad
    \subfloat[\centering Vista física]{{\includegraphics[width=0.6\textwidth]{media/content/estado-arte/client-server-physical.png} }}%
...
O algoritmo de consenso projetado é geralmente utilizado em cenários onde é essencial garantir uma
