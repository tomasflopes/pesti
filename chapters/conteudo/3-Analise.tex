...
Através da análise do problema definido, em conjunto com os requisitos funcionais e
não funcionais delineados anteriormente, o principal objetivo desta secção é documentar
cada fase distinta que compõe o desenho da solução idealizada.
